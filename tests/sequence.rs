...
use serde_asn1_der::{from_bytes, to_vec, SerdeAsn1DerError::Asn1DerError as Error};
...
fn test() {
    ...
    let plain =
        TestStruct { number: 7, vec: b"Testolope".to_vec(), tuple: (4, ()), option: Some("Testolope".to_string()) };
    ...
    let plain = NewtypeTestStruct(TestStruct {
        ...
        tuple: (4, ()),
        option: Some("Testolope".to_string()),
    });
    let der = b"\x30\x20\x02\x01\x07\x04\x09\x54\x65\x73\x74\x6f\x6c\x6f\x70\x65\x30\x05\x02\x01\x04\x05\x00\x0c\x09\x54\x65\x73\x74\x6f\x6c\x6f\x70\x65";
