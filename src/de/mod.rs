...
impl<'de, 'a> serde::de::Deserializer<'de> for &'a mut Deserializer<'de> {
    ...
    fn deserialize_any<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        match self.__peek_object()? {
            ...
            ApplicationTag0::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag0::<()>::NAME, visitor)
            }
            ApplicationTag1::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag1::<()>::NAME, visitor)
            }
            ApplicationTag2::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag2::<()>::NAME, visitor)
            }
            ApplicationTag3::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag3::<()>::NAME, visitor)
            }
            ApplicationTag4::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag4::<()>::NAME, visitor)
            }
            ApplicationTag5::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag5::<()>::NAME, visitor)
            }
            ApplicationTag6::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag6::<()>::NAME, visitor)
            }
            ApplicationTag7::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag7::<()>::NAME, visitor)
            }
            ApplicationTag8::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag8::<()>::NAME, visitor)
            }
            ApplicationTag9::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag9::<()>::NAME, visitor)
            }
            ApplicationTag10::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag10::<()>::NAME, visitor)
            }
            ApplicationTag11::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag11::<()>::NAME, visitor)
            }
            ApplicationTag12::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag12::<()>::NAME, visitor)
            }
            ApplicationTag13::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag13::<()>::NAME, visitor)
            }
            ApplicationTag14::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag14::<()>::NAME, visitor)
            }
            ApplicationTag15::<()>::TAG => {
                self.deserialize_newtype_struct(ApplicationTag15::<()>::NAME, visitor)
            }
            _ => {
                debug_log!("deserialize_any: INVALID");
                Err(SerdeAsn1DerError::InvalidData)
    ...
    fn deserialize_char<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        let c = s
            .chars()
            .next()
            .ok_or(SerdeAsn1DerError::UnsupportedValue)?;
